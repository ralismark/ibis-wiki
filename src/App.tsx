...
import { type JSX, useEffect, useMemo, useReducer, useRef, useState } from "react"
...
function initialWidgets() {
	const widgets: Widget[] = (() => {
		...
		// defaults
		return [new CalendarWidget(), new FileWidget("index"), new TodayWidget()]
	})()
...
function CardsRow(props: { cards: JSX.Element[] }) {
	return (
		<div className="Cards CardsRow">
			{props.cards.map((e) => (
				<div key={e.key} role="none">
					{e}
				</div>
			))}
		</div>
